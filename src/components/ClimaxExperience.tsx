...
type EndReason = 'natural' | 'skip'

interface Props {
  winnerNickname: string
  /** 크롤 종료 시 호출. natural=mp3 자연 종료, skip=사용자 건너뛰기 */
  onCrawlEnd: (reason: EndReason) => void
}

// 우승 즉시 풀스크린 시네마틱 크롤 + climax.mp3 1회 재생.
// 자연 종료 시 → BGM 시작 가능 (부모 결정), 건너뛰기 시 → 즉시 무음 종료.
